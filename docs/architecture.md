...
- Draft de editores: `src/lib/use-draft-items.ts` — estado compartido del "carrito" (items + cantidades + totales) que usan el editor de plantillas y el de comidas; la persistencia y los snapshots viven en los repositorios.
