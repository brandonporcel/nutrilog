...
export default function NewProductPage() {
  ...
  useEffect(() => {
    ...
    void Promise.all([
      ...
      setUnits(unitList);
      // Default serving unit: "Gram" (most labels express macros per 100 g).
  ...
  return (
    ...
    >
      ...
      {/* Fixed save footer (the bottom nav is hidden on this screen) */}
      ...
      {/* Success toast */}
      {saved && (
        <div className="fixed left-1/2 top-20 z-50 flex -translate-x-1/2 items-center gap-2 rounded-full bg-foreground px-6 py-3 text-label-caps text-background shadow-xl">
